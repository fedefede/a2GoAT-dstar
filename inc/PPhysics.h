...
public:
    ...
    void    FillMissingMasscharged_neutral(Int_t particle_index0, Int_t particle_index1, Int_t tagger_index, GH1* gHist, GH1* gHist1, Bool_t TaggerBinning = kFALSE);
    ...
    void    FillTOF_TAPS(Int_t particle_index, GHistBGSub2* gHist);
    void    FillTOF_TAPS_2(const GTreeParticle& tree, Int_t particle_index, GHistBGSub2* gHist);
    void    FillTOF_TAPS(Int_t particle_index, Int_t tagger_index, GHistBGSub2* gHist);
    ...
    void    Fill_theta_neutron_calc_measured_physics(Int_t tagger_index, GH1* gHist, Bool_t TaggerBinning);

    void    Fillcluster_size_track(Int_t track_index, GHistBGSub2* gHist);
    void    Fillcluster_size_track( Int_t track_index, Int_t tagger_index, GHistBGSub2* gHist);
